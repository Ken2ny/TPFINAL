<?php
    ...
    // MODULOS
        ...
        function calcularPromedio ($mes, $matriz) {
            ...
            //  MODULO CARGA MANUAL
            function cargarDatosManual ($meses) {
            $matrizManual = [];      
    ...
    function cargarInvierno($matriz) {
    $invierno = [];
    ...
    function cargarMesPromedio($matriz, $meses) {
    ...
    //Modulo Muestra la temperatura de un anho completo
    function cargarTempAnho($matriz) {
    ...
    //Modulo Muestra la temp de un mes y anho especifico
    function cargarAnhoMes($matriz, $meses) {
    ...
    function calcularMaximaMinima ($matriz, $meses) {
      ...
      $anhoMin = " ";              //Acumulador anhoMinTemp se anota el anho con menor temp
        ...
        case 1:
            ...
            break;
        case 2:
            $matriz = cargarDatosManual($meses);
            echo "Datos Manuales Cargados \n";
            break;
        case 3:
            $tres = cargarMatriz($matriz);
            break;
        case 4:
            $cuatro = cargarAnhoMes($matriz, $meses);
            break;
        case 5:
            $cinco = cargarTempAnho($matriz);
            break;
        case 6:
            $seis = cargarMesPromedio($matriz, $meses); 
            break;  
        case 7:
            $siete = calcularMaximaMinima($matriz, $meses);
            break;
        case 8:
            $ocho = cargarPrimavera($matriz);
            break;
        case 9:
            $nueve = cargarInvierno($matriz);
            break;
        case 10:
            $diez = cargarMatrizAsociativa($matriz);
            break;
        case 0:
            $continuar = false;    // Si eligen opcion 11, se termina el repetir
        }
        //Do while / Repetir
        } while ($continuar);
